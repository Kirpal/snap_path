    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          if (context.select<PathDrawingState, bool>((state) => state.coordinates.length > 1))
          SliverPadding(
              ...
              delegate: SliverChildListDelegate([
                        ...
                        child: AspectRatio(
                          ...
                          child: LayoutBuilder(
                            builder: (context, constraints) {
                              var width = constraints.maxWidth * MediaQuery.of(context).devicePixelRatio;
                              return Image.network(context.watch<MapRepository>().getPreview(coordinates, width.round(), (width / 1.2).round()));
                            }
                          ),
                        ),
                      ),
                ...
                Padding(
                  ...
                  child: OutlineButton(
                    ...
                    onPressed: () => ShareUtils.shareGpx(context.read<PathDrawingState>().elevation.unfiltered),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.only(top: 10),
                  child: FlatButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<AppState>().saveRoute(pathDrawingState.coordinates, pathDrawingState.elevation.gain);
                    },
                  ),
                ),
              ]),
          ...
          SliverToBoxAdapter(
            child: Text('Saved Routes', textAlign: TextAlign.center, style: TextStyle(
            ...
            sliver: Selector<AppState, bool>(
              ...
              builder: (context, metric, _) {
                return Selector<AppState, List<SavedRouteData>>(
                  ...
                  builder: (context, savedRoutes, child) => savedRoutes.isNotEmpty ? SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) => SavedRouteCard(index, savedRoutes[index], metric),
                    ...
                    delegate: SliverChildListDelegate([
                      Padding(
                        ...
                        child: Opacity(
                          ...
                          child: AspectRatio(
                            aspectRatio: 1,
                            child: SvgPicture.asset('assets/illustrations/map_illustration.svg'),
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 40),
                        child: Text('No routes found', textAlign: TextAlign.center, style: TextStyle(
