...
class HighlightedPointMarker extends Marker {
  HighlightedPointMarker(ElevationPoint highlightedPoint) : super(
    width: 60,
    height: 64,
    ...
    builder: (ctx) => Selector<AppState, bool>(
      ...
      builder: (context, metric, _) {
        ...
        if (metric) {
          ...
          distance = '${highlightedPoint.distance.inKilometers.toStringAsFixed(2)}km';
        } else {
          elevation = '${highlightedPoint.elevation.inFeet.round()}ft';
          distance = '${highlightedPoint.distance.inMiles.toStringAsFixed(2)}mi';
        }
          ...
          children: <Widget>[
            Container(
              ...
              child: AutoSizeText('$distance\n$elevation',
                ...
                maxLines: 2,
                style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, height: 1.2),
              ),
            ),
            Container(
              width: 16,
