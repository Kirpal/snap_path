    ...
    return Selector<AppState, bool>(
        ...
        builder: (context, metric, child) {
          return Selector<PathDrawingState, ElevationData>(
              ...
              builder: (context, elevation, child) => elevation.hasData
                  ? LineChart(
                      <Series<ElevationPoint, double>>[
                        Series<ElevationPoint, double>(
                            ...
                            colorFn: (_, __) =>
                                chartColorFrom(Theme.of(context).primaryColor)),
                      ],
                      ...
                      behaviors: [
                        LinePointHighlighter(
                            ...
                            symbolRenderer:
                                CircleSymbolRenderer(isSolid: false)),
                        SelectNearest(
                        ...
                        ChartTitle(
                          ...
                          titleStyleSpec: TextStyleSpec(
                            fontSize: 12,
                            color:
                                chartColorFrom(Theme.of(context).accentColor),
                          ),
                        ),
                        ChartTitle(metric ? 'meters' : 'feet',
                        ...
                        SelectionModelConfig(
                          changedListener: (model) {
                            if (model.selectedDatum.isNotEmpty) {
                              context.read<PathDrawingState>().highlightPoint(
